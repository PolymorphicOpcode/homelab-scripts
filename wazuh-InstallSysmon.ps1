# Author of script integrated with Wazuh 
# Author of sysmon script: Roberto Rodriguez (@Cyb3rWard0g)

[CmdletBinding()]
param (
    [string]$SysmonConfigUrl = "https://raw.githubusercontent.com/SwiftOnSecurity/sysmon-config/refs/heads/master/sysmonconfig-export.xml"
)
